...
"use strict";function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}angular.module("website",["ngRoute","ngTouch","ngAnimate","pascalprecht.translate"]),angular.module("website").config(["$translateProvider",function(a){a.useStaticFilesLoader({prefix:"/i18n/locale-",suffix:".json"}),a.preferredLanguage("fr")}]),angular.module("website").constant(),angular.module("website").config(["$routeProvider","$locationProvider",function(a,b){a.when("/",{templateUrl:"app/views/home/home.html",controller:"HomeController",controllerAs:"home"}),b.html5Mode(!0),a.otherwise({redirectTo:"/"})}]),angular.module("website").run(["$templateCache",function(a){a.put("app/views/home/home.html","<div id=home>{{vm.mavaleur}} Home content</div>")}]),angular.module("ngLocale",[],["$provide",function(a){var b={ZERO:"zero",ONE:"one",TWO:"two",FEW:"few",MANY:"many",OTHER:"other"};a.value("$locale",{DATETIME_FORMATS:{AMPMS:["AM","PM"],DAY:["dimanche","lundi","mardi","mercredi","jeudi","vendredi","samedi"],ERANAMES:["avant Jésus-Christ","après Jésus-Christ"],ERAS:["av. J.-C.","ap. J.-C."],FIRSTDAYOFWEEK:0,MONTH:["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"],SHORTDAY:["dim.","lun.","mar.","mer.","jeu.","ven.","sam."],SHORTMONTH:["janv.","févr.","mars","avr.","mai","juin","juil.","août","sept.","oct.","nov.","déc."],WEEKENDRANGE:[5,6],fullDate:"EEEE d MMMM y",longDate:"d MMMM y",medium:"d MMM y HH:mm:ss",mediumDate:"d MMM y",mediumTime:"HH:mm:ss","short":"dd/MM/y HH:mm",shortDate:"dd/MM/y",shortTime:"HH:mm"},NUMBER_FORMATS:{CURRENCY_SYM:"€",DECIMAL_SEP:",",GROUP_SEP:" ",PATTERNS:[{gSize:3,lgSize:3,maxFrac:3,minFrac:0,minInt:1,negPre:"-",negSuf:"",posPre:"",posSuf:""},{gSize:3,lgSize:3,maxFrac:2,minFrac:2,minInt:1,negPre:"-",negSuf:" ¤",posPre:"",posSuf:" ¤"}]},id:"fr-fr",pluralCat:function(a,c){var d=0|a;return 0==d||1==d?b.ONE:b.OTHER}})}]);var HomeController=function a(b){_classCallCheck(this,a),this.HomeService=b};HomeController.$inject=["HomeService"],angular.module("website").controller("HomeController",HomeController),angular.module("website").controller("HomeService",function(){});