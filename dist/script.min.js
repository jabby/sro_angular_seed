...
"use strict";angular.module("website",["ngRoute","ngTouch","ngAnimate","pascalprecht.translate"]),angular.module("website").config(["$translateProvider",function(e){e.useStaticFilesLoader({prefix:"/i18n/locale-",suffix:".json"}),e.preferredLanguage("fr")}]);
"use strict";angular.module("website").constant();
/*
 AngularJS v1.4.3
 (c) 2010-2015 Google, Inc. http://angularjs.org
 License: MIT
...
angular.module("website").run(["$templateCache", function($templateCache) {$templateCache.put("app/views/home/home.html","<div id=\"home\">bb Home content</div>");}]);
"use strict";
/*
 AngularJS v1.4.3
 (c) 2010-2015 Google, Inc. http://angularjs.org
...
"use strict";angular.module("website").config(["$routeProvider","$locationProvider",function(e,o){e.when("/",{templateUrl:"app/views/home/home.html",controller:"HomeController",controllerAs:"home"}),o.html5Mode(!0),e.otherwise({redirectTo:"/"})}]);
/*
 AngularJS v1.4.3
 (c) 2010-2015 Google, Inc. http://angularjs.org
 License: MIT
...
"use strict";function _classCallCheck(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}var HomeController=function e(o){_classCallCheck(this,e),this.HomeService=o};HomeController.$inject=["HomeService"],angular.module("website").controller("HomeController",HomeController);
"use strict";angular.module("website").controller("HomeService",function(){});